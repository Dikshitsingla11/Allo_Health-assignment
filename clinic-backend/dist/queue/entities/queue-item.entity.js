...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: ['waiting', 'in-progress', 'completed'], default: 'waiting' }),
    __metadata("design:type", String)
], QueueItem.prototype, "status", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: ['normal', 'urgent'], default: 'normal' }),
    __metadata("design:type", String)
...
], QueueItem.prototype, "completedAt", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => patient_entity_1.Patient, patient => patient.queueItems),
    (0, typeorm_1.JoinColumn)({ name: 'patientId' }),
    __metadata("design:type", patient_entity_1.Patient)
], QueueItem.prototype, "patient", void 0);
__decorate([
